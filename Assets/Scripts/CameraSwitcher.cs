...
{
    [Header("References")]
    [SerializeField] private CameraStreamPlayer streamPlayer;
    [SerializeField] private Transform buttonContainer;

    [Header("Camera Identities")]
    [SerializeField] private string[] cameraIdentities =
    {
    ...
    void Start()
    {
        if (LiveKitManager.Instance == null) return;
    ...
    {
        foreach (var identity in cameraIdentities)
        {
